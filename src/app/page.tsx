...
import { Navbar } from "./components/Navbar/page"; // Pastikan path ini sesuai struktur foldermu
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        {/* Background Effect (Blur warna-warni di belakang biar estetik) */}
        <div
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Welcome to Infra Hub
          </h1>
          
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Monitoring laporan vendor Infra PT AINO Indonesia.
          </p>
